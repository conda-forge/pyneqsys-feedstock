...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyneqsys-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11397&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyneqsys-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyneqsys` can be installed with:

```
conda install pyneqsys
```

It is possible to list all of the versions of `pyneqsys` available on your platform with:
